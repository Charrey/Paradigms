...
import pp.block5.cc.antlr.building.BuildingParser.BuildingContext;
import pp.block5.cc.antlr.building.BuildingParser.FloorContext;
...
public class Elevator extends BuildingBaseVisitor<Integer> {
	...
	public Integer visitBuilding(BuildingContext ctx) {
		...
		for (int i = 0; i < floorCount - 1; i++) {
			result += visit(ctx.floor(i)); //Je kan visit meegeven, en dan een context. Je geeft hier een Floor mee dus visitFloor wordt aangeroepen.
			System.out.println("Up one floor"); //Als je nu bijvoorbeeld een Room wil bezoeken geef je een RoomContext mee.
		}
