 ...
 */
public class MyCalcAttrBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MyCalcAttrVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 */
	@Override public T visitT(MyCalcAttrParser.TContext ctx) { return visitChildren(ctx); }
}