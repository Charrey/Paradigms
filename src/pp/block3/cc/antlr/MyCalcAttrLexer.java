...
public class MyCalcAttrLexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	    ...
	    private void error(Type t1, Type t2, String operator) throws pp.block2.cc.ParseException {
	        throw new pp.block2.cc.ParseException("Operator " + operator + " is incompatible with types: " + t1.toString() + " and " + t2.toString() );
	    }


	public MyCalcAttrLexer(CharStream input) {
		super(input);
