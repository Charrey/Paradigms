...
public class DeclUseParser extends Parser {
	...
	public static class UnitseriesContext extends UnitContext {
		public SeriesContext series() {
			return getRuleContext(SeriesContext.class,0);
		}
		public UnitseriesContext(UnitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).enterUnitseries(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).exitUnitseries(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeclUseVisitor ) return ((DeclUseVisitor<? extends T>)visitor).visitUnitseries(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class UnitdeclareContext extends UnitContext {
		public DeclContext decl() {
			return getRuleContext(DeclContext.class,0);
		}
		public UnitdeclareContext(UnitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).enterUnitdeclare(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).exitUnitdeclare(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeclUseVisitor ) return ((DeclUseVisitor<? extends T>)visitor).visitUnitdeclare(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class UnituseContext extends UnitContext {
		public UseContext use() {
			return getRuleContext(UseContext.class,0);
		}
		public UnituseContext(UnitContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).enterUnituse(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DeclUseListener ) ((DeclUseListener)listener).exitUnituse(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeclUseVisitor ) return ((DeclUseVisitor<? extends T>)visitor).visitUnituse(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final UnitContext unit() throws RecognitionException {
		...
		try {
			...
			switch (_input.LA(1)) {
			case T__2:
				_localctx = new UnitdeclareContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(20);
				decl();
				...
				break;
			case T__3:
				_localctx = new UnituseContext(_localctx);
				...
				break;
			case T__0:
				_localctx = new UnitseriesContext(_localctx);
