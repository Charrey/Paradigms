	...
	public final NumContext num() throws RecognitionException {
		...
		try {
			...
			case T__1:
				...
				{
				setState(8);
				((NumContext)_localctx).p = prf();
				setState(9);
				((NumContext)_localctx).s = seq(((NumContext)_localctx).p.type);

				        ((NumContext)_localctx).val =  ((NumContext)_localctx).s.val;
	...
	public final SeqContext seq(int type) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(17);
				((SeqContext)_localctx).d = dig();

				        ((SeqContext)_localctx).length =  1;
				        ((SeqContext)_localctx).val =  ((SeqContext)_localctx).d.val;
			...
			case 2:
				...
				((SeqContext)_localctx).d = dig();
				setState(21);
				((SeqContext)_localctx).s = seq(type);

				        ((SeqContext)_localctx).length =  ((SeqContext)_localctx).s.length + 1;
				        ((SeqContext)_localctx).val =  (((SeqContext)_localctx).d.val * (int) Math.pow(type, ((SeqContext)_localctx).s.length)) + ((SeqContext)_localctx).s.val;
